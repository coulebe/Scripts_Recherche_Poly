...
% load ca06192cb.mat
dataR = load('car06192cb');
dataL = load('cal06192cb');

AR = dataR.car06192cb(:,1) - 1i*dataR.car06192cb(:,2);
AL = dataL.cal06192cb(:,1) + 1i*dataL.cal06192cb(:,2);
