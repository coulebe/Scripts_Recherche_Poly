...
set(AX(1),'ylim',[0,20],'ytick',0:5:20)%设置左y轴数据范围（0到0.5），刻度显示（0,0.1,0.2...0.5）  
set(H2,'Linestyle','-','color',[0.635294139385223 0.0784313753247261 0.184313729405403],'Linewidth',3);
set(AX(2),'ylim',[0.16,0.32],'ytick',0.16:0.02:0.32)%设置右y轴数据范围（0到3），刻度显示（0,1,2,3）  
xlabel('\lambda');
title('cal06252');
set(gca,'linewidth',2);
set(gca,'FontSize',25);
...
set(AX(1),'ylim',[0,20],'ytick',0:5:20)%设置左y轴数据范围（0到0.5），刻度显示（0,0.1,0.2...0.5）  
set(H2,'Linestyle','-','color',[0.635294139385223 0.0784313753247261 0.184313729405403],'Linewidth',3);
set(AX(2),'ylim',[0.20,0.38],'ytick',0.20:0.02:0.38)%设置右y轴数据范围（0到3），刻度显示（0,1,2,3）  
xlabel('\lambda');
title('car06252');
set(gca,'linewidth',2);
set(gca,'FontSize',25);
